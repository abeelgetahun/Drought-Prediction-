            ...
            <tbody>
                <?php if (!empty($stories)): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_story.php?id=<?php echo $story['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
                            <button onclick="confirmDelete(<?php echo $story['id']; ?>)" class="btn btn-sm btn-danger">Delete</button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                <?php else: ?>
