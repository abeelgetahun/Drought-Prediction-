...
<body>
    ...
    <div class="container mt-5 pt-5 mb-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="section-heading"><i class="fas fa-bullseye me-2"></i><?php echo $page_title; ?></h1>
            <a href="add_focus.php" class="btn add-new-btn">
                <i class="fas fa-plus me-2"></i> Add New Focus Category
            </a>
        </div>
            ...
            <div class="card-body p-0">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($focus['description']); ?></td>
                                    <td class="text-end">
                                        <a href="edit_focus.php?id=<?php echo $focus['id']; ?>" class="btn btn-sm btn-edit btn-action">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <button onclick="confirmDelete(<?php echo $focus['id']; ?>)" class="btn btn-sm btn-delete btn-action">
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <h4>No Focus Categories Found</h4>
                        <p class="text-muted">Get started by adding your first focus category.</p>
                        <a href="add_focus.php" class="btn btn-primary mt-3">
                            <i class="fas fa-plus me-2"></i> Add Focus Category
                        </a>
                    </div>
                <?php endif; ?>
            </div>
