...
<body>
    ...
    <div class="container mt-5 pt-5 mb-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="section-heading"><i class="fas fa-newspaper me-2"></i><?php echo $page_title; ?></h1>
            <a href="add_news.php" class="btn add-new-btn">
            ...
            <div class="card-body p-0">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars(date('M d, Y H:i', strtotime($article['publish_date']))); ?></td>
                                    <td class="text-end">
                                        <a href="edit_news.php?id=<?php echo $article['id']; ?>" class="btn btn-sm btn-edit btn-action">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <button onclick="confirmDelete(<?php echo $article['id']; ?>)" class="btn btn-sm btn-delete btn-action">
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p class="text-muted">Get started by adding your first news article.</p>
                        <a href="add_news.php" class="btn btn-primary mt-3">
