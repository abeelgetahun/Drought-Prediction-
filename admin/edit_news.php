    ...
    <div class="container mt-5 pt-5 mb-5">
        ...
        <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <img src="<?php echo (preg_match('/^http(s)?:\/\//', $image_url) ? htmlspecialchars($image_url) : '../' . htmlspecialchars($image_url)); ?>" alt="Current News Image" style="max-width: 200px; height: auto; margin-bottom: 10px;">
            </div>
            <?php endif; ?>
