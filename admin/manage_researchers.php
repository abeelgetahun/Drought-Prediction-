...
<body>
    ...
    <div class="container mt-5 pt-5 mb-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="section-heading"><i class="fas fa-user-friends me-2"></i><?php echo $page_title; ?></h1>
            <a href="add_researcher.php" class="btn add-new-btn">
                <i class="fas fa-plus me-2"></i> Add New Researcher
            </a>
        </div>
            ...
            <div class="card-body p-0">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="edit_researcher.php?id=<?php echo $researcher['id']; ?>" class="btn btn-sm btn-edit btn-action">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <button onclick="confirmDelete(<?php echo $researcher['id']; ?>)" class="btn btn-sm btn-delete btn-action">
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p class="text-muted">Get started by adding your first researcher.</p>
                        <a href="add_researcher.php" class="btn btn-primary mt-3">
                            <i class="fas fa-plus me-2"></i> Add Researcher
                        </a>
                    </div>
                <?php endif; ?>
            </div>
