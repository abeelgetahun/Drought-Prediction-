...
<body>
    ...
    <div class="container mt-5 pt-5 mb-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="section-heading"><i class="fas fa-calendar-alt me-2"></i><?php echo $page_title; ?></h1>
            <a href="add_event.php" class="btn add-new-btn">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="edit_event.php?id=<?php echo $event['id']; ?>" class="btn btn-sm btn-edit btn-action">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <button onclick="confirmDelete(<?php echo $event['id']; ?>)" class="btn btn-sm btn-delete btn-action">
